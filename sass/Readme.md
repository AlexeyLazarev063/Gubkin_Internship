...
folder are mapped to the application's root namespace, 'individualAchievments'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "individualAchievments"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'individualAchievments' in the same way
as `"individualAchievments/sass/src"`.
